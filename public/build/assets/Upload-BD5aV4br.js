import{P as y,j as e}from"./app-DglqJrmE.js";import{A as N}from"./AuthenticatedLayout-BiNbZxPb.js";import{I as g}from"./InputError-cShPoSAm.js";import{P as v}from"./PrimaryButton-DkhVAY3e.js";import{S as i}from"./SecondaryButton-Dyu5Wdui.js";import{T as P}from"./TopMenu-BpOjC3VO.js";import{b as C}from"./Utilities-BvA2Fnuk.js";import"./ApplicationLogo-BY9-i-PO.js";import"./transition-B6yhzviz.js";import"./index-Crzgrt55.js";const F=({auth:t,lesson:s,chapter:l,course:p})=>{console.log(s,l);const{data:r,setData:a,errors:n,post:c}=y({problem:""}),d=o=>{o.preventDefault(),c(route("lesson.uploadProblem",s.id))},u=()=>{let o={...r};o.problem=`texto del problema, ejemplo 3 + 3
