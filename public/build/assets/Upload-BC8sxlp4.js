import{P as y,j as e}from"./app-ByPtaCLL.js";import{A as N}from"./AuthenticatedLayout-DIg3A2kR.js";import{I as g}from"./InputError-CYxAEIje.js";import{P as v}from"./PrimaryButton-BlroIHsX.js";import{S as i}from"./SecondaryButton-B0OYQeFs.js";import{T as P}from"./TopMenu-BYCu_DUz.js";import{b as C}from"./Utilities-BvA2Fnuk.js";import"./ApplicationLogo-CyftJ-t_.js";import"./transition-DQYTFc3b.js";import"./index-Dm47Z7oE.js";const F=({auth:t,lesson:s,chapter:l,course:p})=>{console.log(s,l);const{data:r,setData:a,errors:n,post:c}=y({problem:""}),d=o=>{o.preventDefault(),c(route("lesson.uploadProblem",s.id))},u=()=>{let o={...r};o.problem=`texto del problema, ejemplo 3 + 3
