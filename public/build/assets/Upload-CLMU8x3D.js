import{P as y,j as e}from"./app-k_0gZGwy.js";import{A as N}from"./AuthenticatedLayout-DApGVpAE.js";import{I as g}from"./InputError-BT3O2FYb.js";import{P as v}from"./PrimaryButton-o-AXWC-x.js";import{S as i}from"./SecondaryButton-Bf0-1y0j.js";import{T as P}from"./TopMenu-jlucdeqf.js";import{b as C}from"./Utilities-BvA2Fnuk.js";import"./ApplicationLogo-D6-4P7F4.js";import"./transition-BAaJRcjN.js";import"./index-CQ-lsLJ7.js";const F=({auth:t,lesson:s,chapter:l,course:p})=>{console.log(s,l);const{data:r,setData:a,errors:n,post:c}=y({problem:""}),d=o=>{o.preventDefault(),c(route("lesson.uploadProblem",s.id))},u=()=>{let o={...r};o.problem=`texto del problema, ejemplo 3 + 3
