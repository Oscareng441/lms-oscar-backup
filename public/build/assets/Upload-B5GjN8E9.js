import{P as y,j as e}from"./app-BqrRs8VA.js";import{A as N}from"./AuthenticatedLayout-5EuUQ36E.js";import{I as g}from"./InputError-BqcTHv7R.js";import{P as v}from"./PrimaryButton-Cm3kJkYp.js";import{S as i}from"./SecondaryButton-A_iAguV4.js";import{T as P}from"./TopMenu-B0ektZSO.js";import{b as C}from"./Utilities-BvA2Fnuk.js";import"./ApplicationLogo-stCWA_7e.js";import"./transition-C9ebNJk2.js";import"./index--QCeeFhM.js";const L=({auth:t,lesson:o,chapter:l,course:p})=>{console.log(o,l);const{data:r,setData:a,errors:n,post:c,processing:I}=y({problem:""}),d=s=>{s.preventDefault(),c(route("lesson.uploadProblem",o.id))},u=()=>{let s={...r};s.problem=`texto del problema, ejemplo 3 + 3
