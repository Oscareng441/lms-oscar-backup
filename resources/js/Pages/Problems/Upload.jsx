...
const Upload = ({ auth, lesson, chapter, course }) => {
    ...
    const {data, setData, errors, post, processing} = useForm({ problem: ''})
    const sbm = (e) => {
        e.preventDefault()
            ...
            <div className="py-2">
                <div className="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
                    ...
                    <div className="flex justify-end">
                        <PrimaryButton className="mx-1" type="submit" onClick={ sbm }>subir</PrimaryButton>
                        <SecondaryButton className="mx-1" onClick={ hlp }>ayuda</SecondaryButton>
                        <SecondaryButton className="mx-1" onClick={ clean }>limpiar</SecondaryButton>
                    </div>
                </div>
            </div>
        </AuthenticatedLayout>
