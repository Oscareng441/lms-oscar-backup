    ...
    return (
        <div className="py-2">
            <div className="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
                ...
                <div className="">
                    <label htmlFor="author" className="mr-2">Autor</label>
                    <input
                        type="text"
                        id="author"
                        value={data.author}
                ...
                <div className="">
                    <label htmlFor="source_date" className="mr-2">Fecha</label>
                    <input
                        type="text"
                        id="source_date"
                ...
                <div className="">
                    <label htmlFor="source_name" className="mr-2">Fuente</label>
                    <input
                        type="text"
                        id="source_name"
