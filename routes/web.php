...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/srch', [SearchController::class, 'searchAll'])->name('searchAll');
    Route::get('/run-srch/{srch}', [SearchController::class, 'performSearch'])->name('performSearch');
    ...
    Route::get('/lesson-sets', [ChapterController::class, 'all'])->name('lessonset.all');
    Route::get('/course/{id}', [ChapterController::class, 'index'])->name('lessonset.index');
    Route::get('/chapter/{id}', [ChapterController::class, 'showSet'])->name('lessonset.showset');
    ...
    Route::post('/chapter/save', [ChapterController::class, 'saveChapter'])->name('chapter.save');
    ...
    Route::get('/chapter/{id}/lessons', [ChapterController::class, 'lessons'])->name('chapter.lessons');
